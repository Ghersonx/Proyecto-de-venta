...
public class Empleado {
    ...
    public boolean RegistrarCliente(Empleados cl){
        ...
        try {
            ...
            ps.setString(4, cl.getOcupacion());
            ps.execute();
            return true;
   ...
   public List ListarCliente(){
       List<Empleados> ListaCl = new ArrayList();
   ...
   public boolean ModificarCliente(Empleados cl){
   ...
   public Empleados Buscarcliente(int dni){
       Empleados cl = new Empleados();
